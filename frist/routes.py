...
from frist import app,db,bcrypt,mail
from frist.form import RegistrationForm , LoginForm ,UpdateAccountForm,PostForm,ReqResetForm,ResetPasswordForm
from frist.models import User , Post
...
def save_pic(form_pic):
    ...
    pic_fn=randomhex + fext
    pic_path=os.path.join(app.root_path,'templates/static/profile_pics/',pic_fn)
...
def send_reset_email(user):
    ...
    msg=Message('password reset request',
                sender='mwmnmhmd758@gmail.com',recipients=[user.email])
...
def reset_token(token):
    ...
    if user is None:
        flash('that is invaild or expaired token','warning')
